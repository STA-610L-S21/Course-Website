---
title: "Homework 1"
date: "Due: 11:59pm, Wednesday, February 10"
output: 
  html_document: 
    css: hw.css
    theme: yeti
...
1. <font color="green">OLS Estimation</font> <font color="blue">**(6 points)**</font>
...
2. <font color="green">Game of Thrones</font> <font color="blue">**(8 points)**</font>
...
3. <font color="green">Contrasts</font> <font color="blue">**(4 points)**</font>
...
4. <font color="green">Prove or disprove:</font> <font color="blue">**(2 points)**</font>

    Suppose $X$ and $Y$ each follow *univariate* normal distributions and that $\text{Cov}(X,Y)=0$. Then $X$ is independent of $Y$.
