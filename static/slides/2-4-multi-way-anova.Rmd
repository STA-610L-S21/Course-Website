...
subtitle: "Multi-way ANOVA and interactions"
...
ANOVA is easily extended to accommodate any number of categorical variables. 
...
For example, suppose that we are interested in a two-way ANOVA model in which the response $y$ is a measure of headache pain, and the independent variables include the type of pill taken (placebo (j=1) or ibuprofen (j=2)) and the number of pills taken (k=1 or k=2).
