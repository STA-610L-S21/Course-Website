...
You may find [this link](https://www.rdocumentation.org/packages/rethinking/versions/1.59/topics/dlkjcorr) quite useful along with [instructions for installing the rethinking package](http://xcelab.net/R/rethinking_package.pdf).
...
```{r postre2, echo=FALSE, cache=TRUE, fig.height= 4.5}
post <- posterior_samples(b13.1)
